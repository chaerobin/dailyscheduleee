...
function getApr28Schedule(date: string): ScheduleBlock[] {
  return [
    ...
    b(date, '7:15 – 7:45 AM', 'StretchIt', '', 'fitness'),
    b(date, '7:45 – 8:30 AM', 'Shower + Get Ready', '', 'home'),
    b(date, '8:30 – 8:50 AM', 'Breakfast', 'Take supplements', 'home'),
    b(date, '8:50 – 9:00 AM', 'Floater', 'Chores or catch-up buffer', 'home'),
    b(date, '9:00 – 9:35 AM', 'Meeting: Card Tech/Business Weekly Sync', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work', 'Work'),
    b(date, '9:35 – 10:05 AM', 'Meeting: Paul/Chantel Weekly 10/10', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '10:05 – 10:30 AM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '10:30 – 10:45 AM', 'Outdoor Walk + Self Care Check-In', 'Mental break + self care review while walking', 'fitness'),
    b(date, '10:45 AM – 12:30 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '12:30 – 12:45 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '12:45 – 1:15 PM', 'Lunch', '', 'home'),
    b(date, '1:15 – 3:15 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '3:15 – 3:30 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '3:30 – 4:35 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '4:35 – 5:00 PM', 'Meeting: Real Time Rewards Data Sets', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '5:00 – 5:45 PM', 'Weekly Reset', '', 'home', 'Evening'),
    b(date, '5:45 – 6:30 PM', 'TikTok Recording', 'Record + post', 'home'),
    b(date, '6:30 – 7:30 PM', 'Xenia\'s Bach Trip Shopping', 'Browse + purchase online', 'home'),
    b(date, '7:30 – 8:00 PM', 'Choose Content Deliverable + Set Launch Date', 'DIS — pick one deliverable from 4-week content outline; set publish date', 'home'),
    b(date, '8:00 – 9:25 PM', 'Rest + Recovery', '', 'home'),
    b(date, '9:25 – 9:30 PM', 'Review Day + Gratitude', '', 'home'),
    b(date, '9:30 PM', 'Electronics Off', '1 hour before lights out', 'key'),
    b(date, '9:35 – 9:55 PM', 'RLT + ZIIP', 'Bare face, no multitasking', 'home'),
    b(date, '10:15 – 10:30 PM', 'Bedtime Routine', '', 'home'),
    b(date, '10:30 PM', 'Lights Out', '', 'key'),
  ];
}
...
function getApr29Schedule(date: string): ScheduleBlock[] {
  return [
    ...
    b(date, '6:15 – 7:15 AM', 'Ladder', '', 'fitness'),
    b(date, '7:15 – 7:45 AM', 'StretchIt', '', 'fitness'),
    b(date, '7:45 – 8:30 AM', 'Shower + Get Ready', 'Exfoliate in shower (Wed skincare)', 'home'),
    b(date, '8:30 – 8:50 AM', 'Makeup Practice', '', 'home'),
    b(date, '8:50 – 9:05 AM', 'Breakfast', 'Take supplements', 'home'),
    b(date, '9:05 – 9:35 AM', 'Meeting: Chantel/Jeff Weekly 10/10', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work', 'Work'),
    b(date, '9:35 – 10:00 AM', 'Meeting: EY/SAT Card Recurring Touchpoint', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '10:00 – 10:35 AM', 'Meeting: CRB Meeting', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '10:35 – 11:00 AM', 'Meeting: GitHub Change Monitoring Touchpoint', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '11:00 – 11:15 AM', 'Outdoor Walk + Schedule Dreanna\'s Holistic Doctor', 'Mental break + schedule during walk', 'fitness'),
    b(date, '11:15 AM – 12:30 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '12:30 – 1:00 PM', 'Lunch', '', 'home'),
    b(date, '1:00 – 1:30 PM', 'Meeting: Virtual Coffee Catch-Up', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '1:30 – 2:00 PM', 'Meeting: Weekly Card/GPN SOX Team Meeting', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '2:00 – 2:15 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '2:15 – 3:30 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '3:30 – 3:45 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '3:45 – 4:05 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '4:05 – 4:30 PM', 'Meeting: SOX Controls x Batch Onboarding: Weekly', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '4:30 – 5:00 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '5:00 – 6:30 PM', 'BRAVA Reply + Shaunese\'s Travel Questionnaire + DoorDash Credit', 'Reply to Soraia 4/23 email; complete travel questionnaire; use $10 DoorDash credit', 'home', 'Evening'),
    ...
    b(date, '9:00 – 9:25 PM', 'Review Engagement Data from First 4 Posts', 'DIS — ID top-performing content type; strengthen weeks 4–7 of posting schedule', 'home'),
    b(date, '9:25 – 9:30 PM', 'Review Day + Gratitude', '', 'home'),
    b(date, '9:30 PM', 'Electronics Off', '1 hour before lights out', 'key'),
    b(date, '10:15 – 10:30 PM', 'Bedtime Routine', '', 'home'),
    b(date, '10:30 PM', 'Lights Out', '', 'key'),
...
function getApr30Schedule(date: string): ScheduleBlock[] {
  return [
    ...
    b(date, '8:30 – 8:50 AM', 'Makeup Practice', '', 'home'),
    b(date, '8:50 – 9:05 AM', 'Breakfast', 'Take supplements', 'home'),
    b(date, '9:05 – 9:35 AM', 'Meeting: Jennifer/Chantel Weekly 10/10', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work', 'Work'),
    b(date, '9:35 – 10:00 AM', 'Meeting: SOX FCM Open Forum', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '10:00 – 10:35 AM', 'Meeting: Card Tech/Business Weekly Sync', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '10:35 AM – 12:00 PM', 'Meeting: Revolutionizing Internal Controls', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '12:00 – 12:15 PM', 'Outdoor Walk + OB-GYN Scheduling', 'Mental break + schedule during walk', 'fitness'),
    b(date, '12:15 – 12:45 PM', 'Lunch', '', 'home'),
    b(date, '12:45 – 3:05 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '3:05 – 3:30 PM', 'Meeting: GitHub Change Monitoring Follow-Up', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '3:30 – 3:45 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '3:45 – 4:15 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '4:15 – 4:30 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '4:30 – 5:00 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '5:00 – 6:00 PM', 'Dietitian — Abby Penamonte, RD', 'URL link', 'home', 'Evening'),
    b(date, '6:00 – 6:45 PM', 'Golden Hour', 'Weekly planning session', 'key'),
    b(date, '6:45 – 7:30 PM', 'TikTok Recording', 'Record + post', 'home'),
    b(date, '7:30 – 8:00 PM', 'Research Half Marathons — Next 12 Months', 'DIS — identify 2–3 options; select one and register', 'home'),
    b(date, '8:00 – 8:30 PM', 'Kaftan + Alicia Getty Black House Dress Browse', 'Browse online', 'home'),
    b(date, '8:30 – 9:25 PM', 'Rest + Recovery', '', 'home'),
    b(date, '9:25 – 9:30 PM', 'Review Day + Gratitude', '', 'home'),
    b(date, '9:30 PM', 'Electronics Off', '1 hour before lights out', 'key'),
    b(date, '9:35 – 9:55 PM', 'RLT + ZIIP', 'Bare face, no multitasking', 'home'),
    b(date, '10:15 – 10:30 PM', 'Bedtime Routine', '', 'home'),
...
function getMay1Schedule(date: string): ScheduleBlock[] {
  return [
    ...
    b(date, '9:15 – 9:30 AM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work', 'Work'),
    b(date, '9:30 – 10:00 AM', 'Meeting: Virtual Coffee Catch-Up', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '10:00 – 10:30 AM', 'Meeting: Review Next Week\'s Calendar', 'Seated. Audio-only + no typing? Standing or walking pad ok.', 'work'),
    b(date, '10:30 – 10:45 AM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '10:45 AM – 12:00 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '12:00 – 12:15 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '12:15 – 12:45 PM', 'Lunch', '', 'home'),
    b(date, '12:45 – 4:00 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '4:00 – 4:15 PM', 'Outdoor Walk', 'Mental break', 'fitness'),
    b(date, '4:15 – 5:00 PM', 'Work', 'Stand first 15 min then 30 sit / 15 stand rotation; walking pad ok for low-demand tasks.', 'work'),
    b(date, '5:00 – 7:00 PM', 'Practice Choreography', '', 'home', 'Evening'),
    b(date, '7:00 – 8:15 PM', 'Purchase 1–2 Items for Wedding Wardrobe', 'HP — 75 min', 'home'),
    b(date, '8:15 – 8:30 PM', 'Check RSVP Count', 'Deadline closes today — note count, flag any pending guests', 'home'),
    b(date, '8:30 – 9:00 PM', 'Pick Bebop + Ma\'s Vacation Locations', '', 'home'),
    b(date, '9:00 – 9:25 PM', 'Start Money 101 Training', 'Due today', 'home'),
    b(date, '9:25 – 9:30 PM', 'Review Day + Gratitude', '', 'home'),
    b(date, '9:30 PM', 'Electronics Off', '1 hour before lights out', 'key'),
    b(date, '10:15 – 10:30 PM', 'Bedtime Routine', '', 'home'),
    b(date, '10:30 PM', 'Lights Out', '', 'key'),
...
function getMay2Schedule(date: string): ScheduleBlock[] {
  return [
    ...
    b(date, '8:15 – 9:00 AM', 'Shower + Get Ready', 'Exfoliate in shower (Sat skincare) — serves as leave-house prep for DST, no second shower needed', 'home'),
    b(date, '9:00 – 9:20 AM', 'Breakfast', 'Take supplements', 'home'),
    b(date, '9:20 – 9:50 AM', 'Drive to DST Recess Challenge', '', 'drive', undefined, { text: '1500 Anacostia Ave NE, Washington, DC 20002', color: 'amber' }),
    ...
    b(date, '4:50 – 5:50 PM', 'Rest + Recovery', '', 'home'),
    b(date, '5:50 – 7:00 PM', 'Put That Shit On', 'Prep for Date Night — 70 min', 'home'),
    b(date, '7:00 – 7:30 PM', 'Drive to Date Night', '', 'drive', undefined, { text: 'TBD', color: 'amber' }),
    b(date, '7:30 – 9:30 PM', 'Biweekly Date Night', '', 'errand', undefined, { text: 'TBD', color: 'amber' }),
    b(date, '9:30 – 10:00 PM', 'Drive Home', '', 'drive'),
    b(date, '10:00 – 10:05 PM', 'Review Day + Gratitude', '', 'home', 'Evening'),
    b(date, '10:05 PM', 'Electronics Off', '1 hour before lights out', 'key'),
    b(date, '10:15 – 10:30 PM', 'Bedtime Routine', '', 'home'),
    b(date, '10:30 PM', 'Lights Out', '', 'key'),
  ];
}
...
function getMay3Schedule(date: string): ScheduleBlock[] {
  return [
    ...
    b(date, '8:30 – 8:50 AM', 'Breakfast', 'Take supplements', 'home'),
    b(date, '8:50 – 9:50 AM', 'Book Return Flights — Selves + Parents', 'Due today 5/3', 'home'),
    b(date, '9:50 – 11:20 AM', 'Wardrobe Audit — Part 2 of 2', '90 min — completes audit', 'home'),
    b(date, '11:20 AM – 1:20 PM', 'Review Cole\'s Wedding Photos + Respond', 'Overdue since 4/15 — 2 hrs', 'home'),
    b(date, '1:20 – 1:50 PM', 'Lunch', '', 'home', 'Afternoon'),
    b(date, '1:50 – 4:50 PM', 'Meal Prep with Ashley', 'Max 3 hours — batch cook for the week', 'home'),
    b(date, '4:50 – 5:20 PM', 'Finalize Guest List + Draft Thank You Email to Non-Responders', 'Due today 5/3 — 30 min', 'home'),
    b(date, '5:20 – 5:50 PM', 'Research Investment Vehicles for Surplus Above Emergency Fund', 'DIS — 60 min. Index funds, ETFs, HYSA; set decision deadline 2–3 weeks out', 'home'),
    b(date, '5:50 – 6:20 PM', 'TikTok Recording', 'Record + post', 'home'),
    b(date, '6:20 – 6:50 PM', 'Chase Transfer Portal Check + Budget + Paycheck Allocation', 'Chase transfer check 5 min; budget + USAA transfer $355 + allocate paycheck', 'home'),
    b(date, '6:50 – 7:00 PM', 'Reminders Catch-Up', 'Any remaining items from the week', 'home'),
    b(date, '7:00 – 7:30 PM', 'House Meeting', '', 'home', 'Evening'),
    b(date, '7:30 – 9:25 PM', 'Rest + Recovery', '', 'home'),
    b(date, '9:25 – 9:30 PM', 'Review Day + Gratitude', '', 'home'),
    b(date, '9:30 PM', 'Electronics Off', '1 hour before lights out', 'key'),
    b(date, '9:35 – 9:55 PM', 'RLT + ZIIP', 'Bare face, no multitasking', 'home'),
    b(date, '10:15 – 10:30 PM', 'Bedtime Routine', '', 'home'),
